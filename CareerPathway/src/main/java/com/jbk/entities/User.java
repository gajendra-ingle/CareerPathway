...
public class User {
	...
	@Pattern(regexp = "^(?=.*[A-Z])(?=.*[a-z])(?=.*\\d)(?=.*[@#$%^&+=])[A-Za-z\\d@#$%^&+=]{8,20}$", message = "Password must be 8-20 characters long, include uppercase, lowercase, digit, and a special character, and have no spaces.")
